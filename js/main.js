const body = jQuery("body"), ri = {
    init: function () {
    ...
    }, intervalId: null, currentPopup: null, ajax: function ({
                                                                 data: e, before: t = () => {
        }, result: n = () => {
        }, complete: o = () => {
        }
        ...
        t.length && (window.addEventListener("scroll", function () {
            ...
            e.preventDefault(), jQuery("html, body").animate({scrollTop: 0}, "smooth")
        }))
    }, offCanvas: function () {
        var e = jQuery(".burger"), t = jQuery(".canvas-close"), n = jQuery(".dimmer"), o = {
            label: "",
        ...
        var e = jQuery(".site-header .nav-list"), t = window.location.href;
        ...
        jQuery(".toggle-notify").on("click", function (e) {
            e.preventDefault();
            const t = jQuery(this).find("i"), n = t.attr("class");
            ri.ajax({
                data: {action: "zb_get_site_notify", nonce: zb.ajax_nonce}, before: () => {
        ...
        t.click(function () {
            var e = jQuery(this).find(".show"), t = e.next(".toggle-color>span");
        ...
        var e = jQuery("[data-sticky]"), t = e.siblings("[data-sticky-content]");
        e.height() < t.height() && e.length && e.theiaStickySidebar({updateSidebarHeight: !1, additionalMarginTop: 30})
        ...
        const n = videojs(e), o = (n.on("contextmenu", function (e) {
            e.preventDefault()
        }), n.ready(i), jQuery(".switch-video")), a = jQuery(".video-title .title-span");
        ...
        function i() {
            ...
            /^audio/.test(e) ? ((e = n.el().querySelector(".centered-html-cd")) || n.el().insertAdjacentHTML("beforeend", '<div class="centered-html-cd"><div class="souse-img"><div class="icon-cd"></div><div class="icon-left"></div></div>'), (e = n.el().querySelector(".centered-html-cd")) && e.addEventListener("click", function () {
                ...
                var e = n.el().querySelector(".icon-cd"), t = n.el().querySelector(".icon-left");
        ...
        var e = jQuery(".post-buy-widget"), t = e.find(".ri-down-warp").data("resize"), n = jQuery(".post-content");
        ...
        if (0 != zb.singular_id) {
            var e = jQuery(".post-content"), t = jQuery(".sidebar"), e = e.find("h1, h2, h3");
            if (1 == zb.post_content_nav && 0 < e.length) {
                ...
                jQuery.each(e, function (e, t) {
                    var n = jQuery("<li>"), o = jQuery("<a>").attr("href", "#" + t.id).text(t.text);
                    switch (t.level) {
                        case 1:
                            n.addClass("nav-h1");
                            break;
        ...
        e.length && e.each(function () {
            var e = jQuery(this).data("config") || {}, e = $.extend({}, t, e);
            jQuery(this).owlCarousel(e)
        })
    }, pagination: function () {
        var e = jQuery(".posts-warp");
        const o = jQuery(".infinite-scroll-button"), a = jQuery(".infinite-scroll-status"),
            i = jQuery(".infinite-scroll-msg");
        var t = o.hasClass("infinite-click"), n = (o.hasClass("infinite-auto"), {
            append: ".posts-warp > *",
            debug: !1,
            hideNav: ".pagination",
            history: !1,
        ...
        e.length && (e = e.find('a[href$=".jpg"], a[href$=".jpeg"], a[href$=".png"], a[href$=".gif"]')).length && e.click(function (e) {
            ...
            e.length ? (t = (e = e.find(".gallery-item")).index(jQuery(this).closest(".gallery-item")) + 1, e = e.map(function () {
                return {title: jQuery(this).find(".gallery-caption").text(), src: jQuery(this).find("a").attr("href")}
            }).get(), Spotlight.show(e, {index: t})) : Spotlight.show(jQuery(this))
        })
    }, social_action: function () {
        const n = jQuery(".post-fav-btn"), o = jQuery(".post-like-btn"), a = jQuery(".post-share-btn"),
            i = "post_like_storage";
        new ClipboardJS(".user-select-all", {
            ...
            const e = jQuery(this).find("i"), t = e.attr("class");
            ri.ajax({
                data: {action: "zb_add_like_post", nonce: zb.ajax_nonce, post_id: zb.singular_id}, before: () => {
            ...
            const e = jQuery(this).find("i"), t = e.attr("class");
            ri.ajax({
                data: {action: "zb_add_share_post", nonce: zb.ajax_nonce, post_id: zb.singular_id}, before: () => {
        ...
        const l = document.createElement("canvas"), c = l.getContext("2d"), e = 640, d = 180, t = "bold 24px Arial",
            u = "18px Arial", n = f(r.title, 600, 2, t), o = f(r.desc, 600, 3, u),
            p = 580 + 32 * (n.length + o.length + 1) + 80 + 14,
            a = (l.width = e, l.height = p, c.fillStyle = "#FFFFFF", c.fillRect(0, 0, e, p), new Image);

        function f(e, t, n, o) {
            var a = document.createElement("canvas").getContext("2d"), i = [];
            let r = "";
            a.font = o;
            var s = jQuery("<div>").html(e).text().split("");
            for (let e = 0; e < s.length; e++) {
                var l = s[e];
                if (a.measureText(r + l).width < t && (!n || i.length < n)) r, r += l; else if (i.push(r), r = l, n && i.length === n) break
            }
            return i.push(r), i
        }
        ...
        a.src = r.img, a.crossOrigin = "anonymous", a.onerror = () => (console.log("thumbnailImg error"), ri.popup(s), !1), a.onload = () => {
            ...
            i.src = r.site_logo, i.crossOrigin = "anonymous", i.onerror = () => (console.log("logoImg error"), ri.popup(s), !1), i.onload = () => {
                var e = Math.min(80 / i.height, 600 / i.width), t = i.width * e, e = i.height * e, n = p - 20 - d,
                ...
                a.src = r.qrcode, a.crossOrigin = "anonymous", a.onerror = () => (console.log("qrcodeImg error"), ri.popup(s), !1), a.onload = () => {
                    ...
                    t.find(".share-qrcode").attr("src", e).addClass("p-0"), ri.popup(t.prop("outerHTML"), 320), jQuery(".share-qrcode").click(function () {
                        var e = jQuery(this).attr("src"), t = jQuery("<a>").hide(), n = r.title;
        ...
        const a = jQuery(".infinite-scroll-button"), i = jQuery(".infinite-scroll-status"),
        ...
        o.on("click", function () {
            ...
            n.on("select", function () {
                var e = n.state().get("selection").first().toJSON(), t = e.url, e = e.id;
                jQuery("#_thumbnail_id").val(e), o.empty(), e = jQuery("<img>").attr("src", t), o.append(e)
            }), n.open()
        }), body.on("click", ".add-input-file", function () {
            const t = jQuery(this).closest(".input-group").find(".input-file-url"), n = wp.media({multiple: !1});
            n.on("select", function () {
                var e = n.state().get("selection").first().toJSON().url;
                t.val(e)
            }), n.open()
        });
        const e = jQuery("#cao_video_switch"), t = jQuery("#cao_status_switch"), n = jQuery("#price-input-warp"),
            a = jQuery("#down-input-warp"), i = jQuery("#video-input-warp");
        ...
        const a = jQuery("#captcha-img"), e = jQuery("input[name='captcha_code']"), t = jQuery("#account-from"),
            i = jQuery("#click-submit");
        a.on("click", function () {
            ri.ajax({
                data: {action: "zb_get_captcha_img", nonce: zb.ajax_nonce}, before: () => {
                }, result: ({status: e, msg: t}) => {
            ...
            e.preventDefault();
            e = t.serializeArray();
            let o = decodeURIComponent(location.href.split("redirect_to=")[1] || ""), n = {nonce: zb.ajax_nonce};
        ...
        e.on("click", function () {
            var e = jQuery(this);
            o = {nonce: zb.ajax_nonce, post_id: e.data("id"), order_type: e.data("type"), order_info: e.data("info")};
            const t = e.find("i"), n = t.attr("class");
            ...
            const e = jQuery(this), t = (o.pay_type_id = e.data("id"), o.action = "zb_get_pay_action", e.find("i")),
                n = t.attr("class");
        ...
        e.action = "zb_get_pay_select_html", ri.ajax({
            data: e, result: ({status: e, msg: t}) => {
                1 == e ? ri.popup(t, 240) : ri.notice(t)
            }
        })
    }, order_num_cookie(e = "remove") {
        var t = "_zb_current_order_num", n = window.location.host;
        return "remove" === e ? jQuery.removeCookie(t, {domain: n, path: "/"}) : jQuery.cookie(t)
